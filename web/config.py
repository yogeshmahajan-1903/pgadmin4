...
#############################################################################
# ENABLE_PASS_EXEC_COM is used to enable/disable Password exec command field
# in server properties. This is used to specify a shell command to be executed
# to retrieve a password to be used for server authentication.
#############################################################################
